const { Client, GatewayIntentBits, EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, Collection, SlashCommandBuilder, REST, Routes, AttachmentBuilder } = require('discord.js');
...
const createTicketMainEmbed = () => {
    return new EmbedBuilder()
        ...
        .setImage('attachment://g9-store-logo.png')
        .setColor(0x000000)
        .setTimestamp();
};
            ...
            switch (commandName) {
                ...
                case 'ticket':
                    ...
                    try {
                        ...
                        const attachment = new AttachmentBuilder('images/g9-store-logo.png', { name: 'g9-store-logo.png' });
        ...
        try {
            switch (interaction.customId) {
                ...
                case 'ticket_buy':
                    ...
                    const buyAttachment = new AttachmentBuilder('images/g9-store-logo.png', { name: 'g9-store-logo.png' });
                ...
                case 'ticket_inquiry':
                    ...
                    const inquiryAttachment = new AttachmentBuilder('images/g9-store-logo.png', { name: 'g9-store-logo.png' });
                ...
                case 'ticket_problem':
                    ...
                    const problemAttachment = new AttachmentBuilder('images/g9-store-logo.png', { name: 'g9-store-logo.png' });
